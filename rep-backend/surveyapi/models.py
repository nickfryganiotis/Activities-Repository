...
class Activity(db.Model):
    ...
    activity_translations = db.relationship('Activity_translation', cascade='all, delete', backref='activity')
    activity_competencies = db.relationship('Activity_competency', cascade='all, delete', backref='activity')
    activity_didactic_strategies = db.relationship('Activity_didactic_strategy', cascade='all, delete', backref='activity')
    activity_special_needs = db.relationship('Activity_special_need', cascade='all, delete', backref='activity')
